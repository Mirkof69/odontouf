...
import 'historia_clinica_form_windows.dart';

class HistoriasClinicasViewWindows extends StatefulWidget {
  const HistoriasClinicasViewWindows({super.key});

  @override
  State<HistoriasClinicasViewWindows> createState() =>
      _HistoriasClinicasViewWindowsState();
}

class _HistoriasClinicasViewWindowsState
    extends State<HistoriasClinicasViewWindows> {
  ...
  Future<void> _handleCreateHistoria() async {
    ...
    await showDialog<void>(
      context: context,
      builder: (context) => HistoriaClinicaFormWindows(
