...
class PacienteFormWindows extends StatefulWidget {
  final Paciente? paciente;
  final void Function(Paciente paciente) onSave;
  const PacienteFormWindows({super.key, this.paciente, required this.onSave});

  @override
  State<PacienteFormWindows> createState() => _PacienteFormWindowsState();
}

class _PacienteFormWindowsState extends State<PacienteFormWindows> {
